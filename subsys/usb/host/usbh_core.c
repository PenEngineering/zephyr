...
K_MSGQ_DEFINE(usbh_msgq, sizeof(struct uhc_event), CONFIG_USBH_MAX_UHC_MSG, __alignof(struct uhc_event));
K_MSGQ_DEFINE(usbh_bus_msgq, sizeof(struct uhc_event), CONFIG_USBH_MAX_UHC_MSG, __alignof(struct uhc_event));
